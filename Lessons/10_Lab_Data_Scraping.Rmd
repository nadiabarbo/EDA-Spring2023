...
#Set the URL
theURL_24 <- 'https://waterdata.usgs.gov/nwis/uv?search_site_no=02085070&period=24&format=rdb'

#Get the data, which starts on line 30
gage_data_24 <- read.table(theURL_24,skip = 29,header=TRUE,sep='\t',stringsAsFactors = T)
