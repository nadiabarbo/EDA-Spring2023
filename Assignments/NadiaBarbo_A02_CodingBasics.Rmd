...
```{r}
#1. 
seq100 <- seq(1,100,4) #creating sequence of numbers from 1 to 100, with each number increasing by factor of 4 using the seq function
...
#3. 
mean(seq100) > median(seq100) #determining if the mean of seq100 is greater than the median of seq100 (TRUE or FALSE)
```
...
passedtest <- c(FALSE, TRUE, TRUE, TRUE) # creating vector of whether or not the student passed the test
...
#7. and 8.
testresults.df <- data.frame("Student.Names" = studentnames, "Test.Scores" = testscores, "Passed.Test" = passedtest) #combining previously created vectors into a data frame and naming the columns of the data frame
```
